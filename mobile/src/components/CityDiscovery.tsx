...
const styles = StyleSheet.create({
  radarSection: { gap: 16, paddingVertical: 20, borderRadius: 28, backgroundColor: colors.brandInk, borderWidth: 1, borderColor: "#23365a", overflow: "hidden" },
  companionSection: { gap: 15, padding: 20, borderRadius: 28, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  ...
  companionHeadingTitle: { color: colors.ink, fontSize: 24, lineHeight: 29, fontWeight: "900" },
  ...
  radarCard: { width: 286, overflow: "hidden", borderRadius: 24, backgroundColor: colors.surface },
  ...
  openRadarButton: { minHeight: 50, marginHorizontal: 16, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9, borderRadius: 18, backgroundColor: colors.action },

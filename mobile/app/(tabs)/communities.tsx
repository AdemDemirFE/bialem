...
const styles = StyleSheet.create({
  page: { flexGrow: 1, padding: 20, paddingBottom: 40, gap: 20, backgroundColor: colors.page },
  ...
  viewTab: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 7, paddingHorizontal: 14, borderRadius: 18, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface },
  ...
  sectionTitle: { color: colors.ink, fontSize: 25, lineHeight: 30, fontWeight: "900" },
  ...
  stack: { gap: 18 },
  card: { overflow: "hidden", borderRadius: 30, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, boxShadow: "0 8px 18px var(--bialem-shadow)" },
  ...
  coverTitle: { color: "#ffffff", fontSize: 29, lineHeight: 34, fontWeight: "900" },
  ...
  joinButton: { minHeight: 50, alignItems: "center", justifyContent: "center", borderRadius: 999, backgroundColor: colors.action, paddingHorizontal: 18 },
  disabledButton: { opacity: 0.62 },
  joinButtonText: { color: colors.actionText, textAlign: "center", fontSize: 15, fontWeight: "900" },
  cancelRequestButton: { minHeight: 50, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, borderRadius: 999, borderWidth: 1, borderColor: colors.danger, backgroundColor: colors.surface, paddingHorizontal: 18 },
  cancelRequestButtonText: { color: colors.danger, textAlign: "center", fontSize: 15, fontWeight: "900" },
  openButton: { minHeight: 50, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9, borderRadius: 999, backgroundColor: colors.action, paddingHorizontal: 18 },

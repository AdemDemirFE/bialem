...
const styles = StyleSheet.create({
  page: { flexGrow: 1, gap: 20, padding: 18, paddingBottom: 38, backgroundColor: colors.page },
  brandHero: { gap: 11, marginTop: 8, padding: 18, borderRadius: 26, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  ...
  heroTitle: { color: colors.ink, fontSize: 30, lineHeight: 35, fontWeight: "900", letterSpacing: -0.6 },
  ...
  storiesSection: { gap: 13, paddingVertical: 17, borderRadius: 28, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  advantageCard: { flexDirection: "row", alignItems: "center", gap: 13, padding: 17, borderRadius: 24, backgroundColor: colors.brandInk, borderWidth: 1, borderColor: "#23365a" },
  ...
  nowSection: { gap: 14, padding: 20, borderRadius: 30, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.warning },
  section: { gap: 15, padding: 20, borderRadius: 30, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },

...
const styles = StyleSheet.create({
  ...
  hero: { gap: 7, padding: 18, borderRadius: 21, backgroundColor: colors.brandInk },
  heroIcon: { width: 46, height: 46, alignItems: "center", justifyContent: "center", borderRadius: 15, backgroundColor: colors.action },
  kicker: { color: colors.action, fontSize: 11, fontWeight: "900", letterSpacing: 1.4 },
  title: { maxWidth: 330, color: colors.onBrand, fontSize: 25, lineHeight: 31, fontWeight: "900" },
  ...
  panel: { padding: 14, borderRadius: 18, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface },
  ...
  settingRow: { minHeight: 64, flexDirection: "row", alignItems: "center", gap: 10, borderBottomWidth: 1, borderBottomColor: colors.border },

...
const styles = StyleSheet.create({
  page: { flexGrow: 1, gap: 14, padding: 16, paddingTop: 22, paddingBottom: 38, backgroundColor: colors.page },
  ...
  list: { gap: 12 },
  card: { gap: 11, padding: 13, borderRadius: 17, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface },
  personRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  avatar: { width: 50, height: 50, alignItems: "center", justifyContent: "center", overflow: "hidden", borderRadius: 25, borderWidth: 2, borderColor: colors.accent, backgroundColor: colors.accentSoft },

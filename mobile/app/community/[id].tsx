...
const styles = StyleSheet.create({
  page: { flexGrow: 1, padding: 20, paddingBottom: 44, gap: 18, backgroundColor: colors.page },
  loadingBox: { minHeight: 360, alignItems: "center", justifyContent: "center" },
  hero: { overflow: "hidden", padding: 24, gap: 10, borderRadius: 30, backgroundColor: colors.brandInk },
  kicker: { color: colors.action, fontSize: 11, fontWeight: "900", letterSpacing: 1.5 },
  title: { color: colors.onBrand, fontSize: 34, lineHeight: 39, fontWeight: "900" },
  ...
  primaryButton: { minHeight: 49, flexDirection: "row", alignItems: "center", justifyContent: "center", borderRadius: 999, paddingHorizontal: 17, backgroundColor: colors.action },
  primaryButtonText: { color: colors.actionText, fontSize: 14, fontWeight: "900" },
  outlineButton: { minHeight: 49, alignItems: "center", justifyContent: "center", borderRadius: 999, borderWidth: 1, borderColor: colors.accent },

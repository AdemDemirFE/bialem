...
const styles = StyleSheet.create({
  ...
  title: { color: colors.onBrand, fontSize: 25, fontWeight: "900" },
  ...
  panel: { gap: 11, padding: 15, borderWidth: 1, borderColor: colors.border, borderRadius: 18, backgroundColor: colors.surface },
  ...
  primaryButton: { minHeight: 44, alignItems: "center", justifyContent: "center", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 14, backgroundColor: colors.accent },

...
const styles = StyleSheet.create({
  ...
  empty: { alignItems: "center", gap: 8, marginTop: 70 }, emptyTitle: { color: colors.ink, fontSize: 18, fontWeight: "900" }, muted: { color: colors.muted, textAlign: "center" }, error: { color: colors.danger, textAlign: "center", paddingHorizontal: 16, paddingVertical: 7, fontWeight: "700" }, composer: { flexDirection: "row", alignItems: "flex-end", gap: 9, padding: 12, backgroundColor: colors.surface, borderTopWidth: 1, borderTopColor: colors.border }, input: { flex: 1, maxHeight: 120, minHeight: 48, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 22, color: colors.ink, backgroundColor: colors.page, borderWidth: 1, borderColor: colors.border }, send: { width: 48, height: 48, borderRadius: 18, alignItems: "center", justifyContent: "center", backgroundColor: colors.action }, disabled: { opacity: 0.4 }
});

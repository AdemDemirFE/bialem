...
@Component
public class EventMessageMapperImpl implements EventMessageMapper {

    @Override
    public EventMessage toEntity(EventMessageDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        eventMessage.setId( dto.getId() );
        eventMessage.setBody( dto.getBody() );
        eventMessage.setModerationStatus( dto.getModerationStatus() );
        eventMessage.setCreatedAt( dto.getCreatedAt() );
        eventMessage.setUpdatedAt( dto.getUpdatedAt() );
        eventMessage.event( eventDTOToEvent( dto.getEvent() ) );
        eventMessage.author( profileDTOToProfile( dto.getAuthor() ) );

        return eventMessage;
    }

    @Override
    public List<EventMessage> toEntity(List<EventMessageDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<EventMessage> list = new ArrayList<EventMessage>( dtoList.size() );
        for ( EventMessageDTO eventMessageDTO : dtoList ) {
            list.add( toEntity( eventMessageDTO ) );
        }
    ...
    @Override
    public List<EventMessageDTO> toDto(List<EventMessage> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<EventMessageDTO> list = new ArrayList<EventMessageDTO>( entityList.size() );
        for ( EventMessage eventMessage : entityList ) {
            list.add( toDto( eventMessage ) );
        }
    ...
    @Override
    public void partialUpdate(EventMessage entity, EventMessageDTO dto) {
        if ( dto == null ) {
            return;
        }
    ...
    @Override
    public EventMessageDTO toDto(EventMessage s) {
        if ( s == null ) {
            return null;
        }
        ...
        eventMessageDTO.setEvent( toDtoEventId( s.getEvent() ) );
        eventMessageDTO.setAuthor( toDtoProfileId( s.getAuthor() ) );
        eventMessageDTO.setId( s.getId() );
        eventMessageDTO.setBody( s.getBody() );
        eventMessageDTO.setModerationStatus( s.getModerationStatus() );
        eventMessageDTO.setCreatedAt( s.getCreatedAt() );
        eventMessageDTO.setUpdatedAt( s.getUpdatedAt() );

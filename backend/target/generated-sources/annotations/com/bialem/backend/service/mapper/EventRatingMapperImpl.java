...
@Generated(
    ...
    date = "2026-08-20T22:10:26+0300",
    comments = "version: 1.6.3, compiler: Eclipse JDT (IDE) 3.46.100.v20260624-0231, environment: Java 21.0.11 (Eclipse Adoptium)"
)
@Component
public class EventRatingMapperImpl implements EventRatingMapper {

    @Override
    public EventRating toEntity(EventRatingDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        eventRating.setId( dto.getId() );
        eventRating.setRating( dto.getRating() );
        eventRating.setReviewText( dto.getReviewText() );
        eventRating.setCreatedAt( dto.getCreatedAt() );
        eventRating.setUpdatedAt( dto.getUpdatedAt() );
        eventRating.event( eventDTOToEvent( dto.getEvent() ) );
        eventRating.user( profileDTOToProfile( dto.getUser() ) );

        return eventRating;
    }

    @Override
    public List<EventRating> toEntity(List<EventRatingDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<EventRating> list = new ArrayList<EventRating>( dtoList.size() );
        for ( EventRatingDTO eventRatingDTO : dtoList ) {
            list.add( toEntity( eventRatingDTO ) );
        }
    ...
    @Override
    public List<EventRatingDTO> toDto(List<EventRating> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<EventRatingDTO> list = new ArrayList<EventRatingDTO>( entityList.size() );
        for ( EventRating eventRating : entityList ) {
            list.add( toDto( eventRating ) );
        }
    ...
    @Override
    public void partialUpdate(EventRating entity, EventRatingDTO dto) {
        if ( dto == null ) {
            return;
        }
    ...
    @Override
    public EventRatingDTO toDto(EventRating s) {
        if ( s == null ) {
            return null;
        }
        ...
        eventRatingDTO.setEvent( toDtoEventId( s.getEvent() ) );
        eventRatingDTO.setUser( toDtoProfileId( s.getUser() ) );
        eventRatingDTO.setId( s.getId() );
        eventRatingDTO.setRating( s.getRating() );
        eventRatingDTO.setReviewText( s.getReviewText() );
        eventRatingDTO.setCreatedAt( s.getCreatedAt() );
        eventRatingDTO.setUpdatedAt( s.getUpdatedAt() );

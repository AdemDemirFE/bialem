package com.bialem.backend.repository.timezone;
...
public abstract class DateTimeWrapper_ {
	...
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper#localDateTime
	 **/
	public static volatile SingularAttribute<DateTimeWrapper, LocalDateTime> localDateTime;
	
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper#localTime
	 **/
	public static volatile SingularAttribute<DateTimeWrapper, LocalTime> localTime;
	
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper#zonedDateTime
	 **/
	public static volatile SingularAttribute<DateTimeWrapper, ZonedDateTime> zonedDateTime;
	
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper#offsetTime
	 **/
	public static volatile SingularAttribute<DateTimeWrapper, OffsetTime> offsetTime;
	
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper#offsetDateTime
	 **/
	public static volatile SingularAttribute<DateTimeWrapper, OffsetDateTime> offsetDateTime;
	
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper#id
	 **/
	public static volatile SingularAttribute<DateTimeWrapper, Long> id;
	
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper#localDate
	 **/
	public static volatile SingularAttribute<DateTimeWrapper, LocalDate> localDate;
	
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper
	 **/
	public static volatile EntityType<DateTimeWrapper> class_;
	
	/**
	 * @see com.bialem.backend.repository.timezone.DateTimeWrapper#instant
	 **/

...
class PostResourceIT {
    ...
    private static final PostVisibility UPDATED_VISIBILITY = PostVisibility.COMMUNITY_ONLY;
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.visibility(UPDATED_VISIBILITY).moderationStatus(UPDATED_MODERATION_STATUS);

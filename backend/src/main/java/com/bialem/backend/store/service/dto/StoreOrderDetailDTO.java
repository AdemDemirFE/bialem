...
public class StoreOrderDetailDTO implements Serializable {
    ...
    private StoreAddressDTO shippingAddress;
    private StoreAddressDTO billingAddress;
    private List<StoreOrderItemDTO> items = new ArrayList<>();
    private StorePaymentDTO payment;
    private StoreShippingDTO shipping;
    private List<StoreOrderStatusHistoryDTO> statusHistory = new ArrayList<>();
    ...
    public StoreAddressDTO getShippingAddress() {
        return shippingAddress;
    }

    public void setShippingAddress(StoreAddressDTO shippingAddress) {
        this.shippingAddress = shippingAddress;
    }

    public StoreAddressDTO getBillingAddress() {
        return billingAddress;
    }

    public void setBillingAddress(StoreAddressDTO billingAddress) {
    ...
    public StorePaymentDTO getPayment() {
        return payment;
    }

    public void setPayment(StorePaymentDTO payment) {
        this.payment = payment;
    }

    public StoreShippingDTO getShipping() {
        return shipping;
    }

    public void setShipping(StoreShippingDTO shipping) {
        this.shipping = shipping;
    }

    public List<StoreOrderStatusHistoryDTO> getStatusHistory() {
        return statusHistory;
    }

    public void setStatusHistory(List<StoreOrderStatusHistoryDTO> statusHistory) {
